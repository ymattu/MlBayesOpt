...
In only `xgb_cv_opt()` function, the returned value means the value you specified in `evalmetric` option, so when you specify the evaluation metric "merror", the value is minus.
